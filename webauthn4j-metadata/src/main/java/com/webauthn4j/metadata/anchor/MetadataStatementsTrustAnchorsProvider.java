...
import com.webauthn4j.metadata.MetadataBLOBMetadataStatementsProvider;
...
public class MetadataStatementsTrustAnchorsProvider implements TrustAnchorsProvider {
    ...
    public MetadataStatementsTrustAnchorsProvider(MetadataBLOBProvider metadataBLOBProvider){
        this(new MetadataBLOBMetadataStatementsProvider(metadataBLOBProvider));
    }
